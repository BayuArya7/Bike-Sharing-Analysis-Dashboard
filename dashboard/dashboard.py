...
# Load dataset
day_data = pd.read_csv(r'C:\Users\asus\Bayu\Training\Dicoding\submission\dashboard\day_preprocessed.csv')
hour_data = pd.read_csv(r'C:\Users\asus\Bayu\Training\Dicoding\submission\dashboard\hour_preprocessed.csv')
